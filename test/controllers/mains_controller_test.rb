...
class MainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create main" do
    assert_difference('Main.count') do
      post mains_url, params: { main: { patient_id: @main.patient_id, text_entry: @main.text_entry, view: @main.view } }
    end
  ...
  test "should update main" do
    patch main_url(@main), params: { main: { patient_id: @main.patient_id, text_entry: @main.text_entry, view: @main.view } }
